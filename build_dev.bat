...
REM Remove MinGW from PATH to avoid GCC being picked up
...
cmake -G "Visual Studio 17 2022" -A x64 -S "%~dp0." -B "%~dp0build_dev" ^
...
cmake --build "%~dp0build_dev" --config Release --parallel
if errorlevel 1 exit /b 1
